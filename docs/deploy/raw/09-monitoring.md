...
> Detect when a series drifts from its normal — CUSUM, EWMA, weekly deseasonalization and multi-series monitoring.
...
<tbody>
  <tr>
    <td>
      <a href="/09-monitoring/01-cusum">
        CUSUM
      </a>
    </td>
    
    <td>
      cumulative sum — sensitive to small sustained shifts
    </td>
  </tr>
  
  <tr>
    <td>
      <a href="/09-monitoring/02-ewma">
        EWMA
      </a>
    </td>
    
    <td>
      exponential smoothing — fewer false alarms on noise
    </td>
  </tr>
  
  <tr>
    <td>
      <a href="/09-monitoring/03-parallel-monitor">
        ParallelMonitor
      </a>
    </td>
    
    <td>
      several series at once, per-field alerts
    </td>
  </tr>
  
  <tr>
    <td>
      <a href="/09-monitoring/04-seasonal-monitor">
        SeasonalMonitor
      </a>
    </td>
    
    <td>
      removes the weekly cycle before detecting
    </td>
  </tr>
</tbody>
</table>
