---
title: Overview
description: Instance-based learning — KNeighborsClassifier and KNeighborsRegressor predict from the nearest labeled examples.
---
...
| Model | Purpose |
| ----- | ------- |
| [KNeighborsClassifier](/05-neighbors/01-kneighbors-classifier) | majority vote of the k nearest labeled examples |
| [KNeighborsRegressor](/05-neighbors/02-kneighbors-regressor) | average of the k nearest target values |
