...
class LinearRegression {
   ...
   */
  setParams(params: LinearParams): this {
    const allowed: (keyof LinearParams)[] = ["coef", "intercept"];
    for (const key of Object.keys(params) as (keyof LinearParams)[]) {
   ...
   */
  getParams(): Required<LinearParams> {
